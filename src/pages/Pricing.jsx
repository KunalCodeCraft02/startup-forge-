  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16">
      <div className="text-center mb-12">
        ...
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 tracking-tight">Simple, founder-friendly pricing.</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
        {PLANS.map((p) => (
          <div key={p.name} className="card-3d">
            <div className={`card-3d-inner p-5 sm:p-7 ${p.highlight ? "ring-2 ring-violet-300/50 shadow-xl shadow-violet-200/20" : ""}`}>
              {p.highlight && <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10"><span className="rounded-full bg-gradient-to-r from-violet-500 to-cyan-400 text-white text-[10px] px-3 sm:px-4 py-1.5 font-bold uppercase tracking-wider shadow-lg shadow-violet-300/30">Most popular</span></div>}
